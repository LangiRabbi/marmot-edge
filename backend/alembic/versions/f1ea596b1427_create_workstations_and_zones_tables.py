...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_alert_settings_id"), "alert_settings", ["id"], unique=False
    )
    op.create_table(
        "system_settings",
    ...
    op.create_index(
        op.f("ix_workstations_name"), "workstations", ["name"], unique=False
    )
    op.create_table(
        "efficiency_records",
    ...
    op.create_index(
        op.f("ix_efficiency_records_id"), "efficiency_records", ["id"], unique=False
    )
    op.create_table(
        "zones",
        sa.Column("name", sa.String(length=255), nullable=False),
